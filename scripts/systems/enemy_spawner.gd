...
@export var ranged_ramp_start_seconds: float = 180.0
@export var ranged_ratio_wave_strength: float = 0.06
@export var ranged_ratio_wave_period_seconds: float = 41.0
@export var batch_ramp_start_seconds: float = 58.0
@export var batch_ramp_end_seconds: float = 300.0
@export var max_spawn_batch: int = 5
@export var post_ramp_batch_growth_interval_seconds: float = 45.0
@export var post_ramp_batch_growth_max_bonus: int = 3
@export var spawn_speed_ramp_start_seconds: float = 60.0
@export var spawn_speed_ramp_end_seconds: float = 290.0
