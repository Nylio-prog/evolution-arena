...
@export var initial_wait_time: float = 1.45
@export var min_wait_time: float = 0.28
@export var ramp_duration_seconds: float = 260.0
@export var spawn_ramp_delay_seconds: float = 30.0
@export var spawn_distance: float = 480.0
@export var dasher_initial_ratio: float = 0.12
@export var dasher_max_ratio: float = 0.56
@export var dasher_ramp_start_seconds: float = 32.0
@export var dasher_ratio_wave_strength: float = 0.10
@export var dasher_ratio_wave_period_seconds: float = 34.0
@export var ranged_initial_ratio: float = 0.0
@export var ranged_max_ratio: float = 0.28
@export var ranged_ramp_start_seconds: float = 235.0
@export var ranged_ratio_wave_strength: float = 0.06
@export var ranged_ratio_wave_period_seconds: float = 41.0
@export var batch_ramp_start_seconds: float = 95.0
@export var batch_ramp_end_seconds: float = 420.0
@export var max_spawn_batch: int = 4
@export var post_ramp_batch_growth_interval_seconds: float = 65.0
@export var post_ramp_batch_growth_max_bonus: int = 2
@export var spawn_speed_ramp_start_seconds: float = 80.0
@export var spawn_speed_ramp_end_seconds: float = 360.0
@export var spawn_speed_max_multiplier: float = 1.22
@export var spawn_hp_ramp_start_seconds: float = 60.0
@export var spawn_hp_ramp_end_seconds: float = 390.0
@export var spawn_hp_max_multiplier: float = 1.55
@export var spawn_damage_ramp_start_seconds: float = 120.0
@export var spawn_damage_ramp_end_seconds: float = 420.0
